...
- When writing or updating documentation, derive ALL instructions and values from the actual source files provided as context — filenames, commands, config keys, environment variables, ports, paths, and flags must be real values taken directly from the code.
