...
- If the prompt includes a project file plan listing what each file owns, do NOT define symbols (types, functions, variables, constants) that are explicitly owned by other files. Reference them by importing or using the file that owns them.
